...
def write_to_csv(data):
    ...
    with open("Philadelphia Area.csv", "a") as f:
        f.write(','.join(data)+'\n')
...
for i in range(1,26):
    ...
    # print (key)
    thispageurl = "https://www.niche.com/places-to-live/search/best-places-to-live/m/philadelphia-metro-area/?type=suburb&type=city&type=cityNeighborhood&type=town&page=" + str(i)
